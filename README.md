# ADS1x20
C++ Arduiono library for the Texas Instruments ADS1120 and ADS1220 ADC, for thermocouple and PT100 measurements
...
# Examples
**Arduino_ADS1120.ino** runs on Arduino boards such as the Uno, Nano or Pro Mini. It demonstrates the use of the ADS1220 class for PT100 and K-type thermocouple temperature measurements.

**TiNo2_ADS1120.ino** runs in the TiNo2 ecosystem and demonstrates the use of the wrapper classes.
